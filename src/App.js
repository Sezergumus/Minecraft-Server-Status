...
function App() {
  ...
  useEffect(() => {
    ...
    fetch('https://mcapi.us/server/status?ip=mc.interaktifis.fun')
  ...
  return(
    <div>
      ...
      <div className="app-container">
        <img src="https://minecraftskinstealer.com/achievement/2/Interaktifis+Minecraft+/mc.interaktifis.fun" className="minecraft-achievement" alt="Minecraft Achievement" /> 
        <table>
          <tbody>
